...
export const NOTIFY_EMAILS = 'mrnnmthembu@gmail.com,info@scenta-holics.com';
...
export const COMPANY_DESCRIPTION = 'Hey there! I am using Scenta Holics.';


export const SEND_EMAIL_RESET_PASSWORD = 'https://scenta-holics.com//api/api/email/email-reset-password-link.php';
export const SEND_EMAIL_ACTIVATE_ACCOUNT = 'https://scenta-holics.com//api/api/email/email-welcome-activate-account.php';
export const SEND_EMAIL_GENERAL_TEXT = 'https://scenta-holics.com//api/api/email/general-email.php';
export const SEND_EMAIL_BILLING = 'https://scenta-holics.com//api/api/email/email-billing.php';
