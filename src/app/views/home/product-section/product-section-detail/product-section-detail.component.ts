...
import { DISCOUNT_APPLIES_TO, DISCOUNT_GROUP, INTERRACTION_TYPE_LIKE, NOTIFY_EMAILS, ORDER_TYPE_SALES } from 'src/shared/constants';
    ...
    this.productService.getProductSync(this.productSlug).subscribe(data => {
      if (data && data.ProductId) {
        ...
        if (this.product) {
          ...
          this.productService.applyPromotionOnSigleProduct(this.promotions, this.product);
